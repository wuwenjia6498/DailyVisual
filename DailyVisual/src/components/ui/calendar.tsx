  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "bg-foreground/20 text-foreground font-medium rounded-md data-[selected=true]:rounded-none",
...
function CalendarDayButton({
  ...
  // 检查是否有内容（通过 modifiers.hasContent）
  const hasContent = modifiers.hasContent
